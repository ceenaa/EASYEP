...
def parse_args(
    ...
    parser.add_argument("--expert-mask", dest="expert_mask_path", default=None,
                        help="Experimental DeepSeek-V4 checkpoint-bound expert mask JSON.")
    parser.add_argument("--expert-stats", dest="expert_stats_path", default=None,
                        help="Experimental eager V4 replay statistics; requires offload, naive cache, batch 1, graphs disabled.")
    parser.add_argument("--expert-stats-decode", action="store_true", default=False,
                        help="Also trace live decode routes and outputs; use with --expert-stats for instrumentation smoke tests.")
